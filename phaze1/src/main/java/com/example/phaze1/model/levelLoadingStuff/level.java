...
public class level {
    ...
    private ArrayList<pockets> pockets = new ArrayList<>();
    ...
    public ArrayList<pockets> getPockets() {return pockets;}

    public void setPockets(ArrayList<pockets> pockets) {this.pockets = pockets;}
}
